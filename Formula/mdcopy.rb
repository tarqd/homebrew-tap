class Mdcopy < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tarqd/mdcopy/releases/download/v0.1.1/mdcopy-aarch64-apple-darwin.tar.gz"
      sha256 "d64e4b6ea0f4674856f454a34aeee098c540312e98acb79209e7d816f9e89d61"
    end
    on_intel do
      url "https://github.com/tarqd/mdcopy/releases/download/v0.1.1/mdcopy-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/tarqd/mdcopy/releases/download/v0.1.1/mdcopy-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "66bb7d3a083058cbddc9b602f5ee4ec86ff3144780fd7e677395c9dd3671396b"
    end
    on_intel do
      url "https://github.com/tarqd/mdcopy/releases/download/v0.1.1/mdcopy-x86_64-unknown-linux-gnu.tar.gz"
